...
import com.example.filterapp.databinding.ItemContaianerFilterBinding
...
class ImageFiltersAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ImageFilterViewHolder {
        val binding = ItemContaianerFilterBinding.inflate(
    ...
    inner class ImageFilterViewHolder(val binding: ItemContaianerFilterBinding) :
